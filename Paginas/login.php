<?php
    ...
    {
        $queryusuario = mysqli_query($conn,"SELECT * FROM user 
        WHERE user_email = '".$nombre."' AND user_password = '".$pass."'");
    ...
    if(isset($_POST["btnregistrarx"]))
    {
        ...
        if ($nr == 0)
        {
            ...
            $queryregistrar = "INSERT INTO user(user_email, user_password) values ('$nombre','$pass')";
