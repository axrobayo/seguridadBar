...
<body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://img.freepik.com/foto-gratis/comida-ingredientes_1220-4884.jpg?t=st=1655237359~exp=1655237959~hmac=7523f75499cc47067965ec2d57a3559a640939721df1568bae32e8929025c369&w=996');">
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    
	<!--Main Col-->
	<div id="profile" class="w-full lg:w-15 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 class="text-3xl font-bold pt-8 lg:pt-0">Lista de Bares</h1>
            ...
            <table class='mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>
                <thead class="bg-gray-900">
                    ...
                    <th class="font-semibold text-sm uppercase px-6 py-4"> Id </th>
                        <th class="font-semibold text-sm uppercase px-6 py-4"> CAMPUS</th>
                        <th class="font-semibold text-sm uppercase px-6 py-4 text-center"> Nombre del bar </th>
		...
		foreach($query as $row){?>
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center"> <span class="text-white text-sm w-1/3 pb-1 bg-green-600 font-semibold px-2 rounded-full"> <?php echo $row['bar_nombre'] ?> </span> </td>
                        <td class="px-6 py-4 text-center"><?php echo $row['bar_abierto'] ?></td>
